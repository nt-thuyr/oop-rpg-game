...
//
//public class NPC_BigRock extends Character {
//
...
//        ArrayList<Character> rockList = new ArrayList<>();
//
//        // Create a plate list
...
//            Character npc = gp.getNpc()[gp.getCurrentMap()][i];
