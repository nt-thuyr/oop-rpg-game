...
public class Player extends Character {
    ...
    public void getGuardImage() {
        setGuardUp(setup("/player/boy_guard_up", gp.getTileSize(), gp.getTileSize()));
        setGuardDown(setup("/player/boy_guard_down", gp.getTileSize(), gp.getTileSize()));
        setGuardLeft(setup("/player/boy_guard_left", gp.getTileSize(), gp.getTileSize()));
        setGuardRight(setup("/player/boy_guard_right", gp.getTileSize(), gp.getTileSize()));
    }
