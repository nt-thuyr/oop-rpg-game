    ...
    public void drawDialogueScreen() {
        ...
        if (npc.getDialogues()[npc.getDialogueSet()][npc.getDialogueIndex()] != null) {
            ...
            if (gp.getGameState() == gp.getCutsceneState()) {
                gp.getCsManager().setScenePhase(gp.getCsManager().getScenePhase() + 1);
            }
        }
    ...
    public void drawInventory(Entity entity, boolean isTrading, boolean cursor, int frameX, int frameY, int frameWidth, int frameHeight, int slotCol, int slotRow) {
        ...
        for (int i = 0; i < entity.getInventory().size(); i++) {
            ...
            if (entity == gp.getPlayer() && entity.getInventory().get(i).getAmount() > 1) {
                ...
                int amountX = getXforAlignToRight("" + entity.getInventory().get(i).getAmount(), slotX + 44);
                int amountY = slotY + gp.getTileSize();
                g2.setColor(new Color(60, 60, 60));
                g2.drawString("" + entity.getInventory().get(i).getAmount(), amountX, amountY);
                g2.setColor(Color.white);
                g2.drawString("" + entity.getInventory().get(i).getAmount(), amountX - 3, amountY - 3);
            }
        ...
        if (cursor) {
            ...
            if (itemIndex < entity.getInventory().size()) {
                ...
                if (isTrading) {
                    // Price
                    int price = entity == getNpc() ? entity.getInventory().get(itemIndex).getPrice() : entity.getInventory().get(itemIndex).getPrice() / 2;
                    textY += 32;
